...
return (
  ...
  <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
            ...
            and am often amazed on the ever growing of programming lanaguages. </p>
                 <p> Click here to download my CV/Resume  currently is short as i have recently graduate😅 </p>
...
<Timeline mode="alternate">
    ...
    <Timeline.Item color="green">Write Up CV and Build Up Github Repo so that it work Ready 2021 July to Augest</Timeline.Item>
    <Timeline.Item color="red">
    Apply for a Graduate Role in Software development 2021 Augest to Decemeber
    </Timeline.Item>
